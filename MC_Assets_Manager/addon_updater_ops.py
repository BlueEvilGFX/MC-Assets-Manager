...
def update_settings_ui_medium(self, context, element=None):
...
def register(bl_info):
	...
	updater.user = "BlueEvilGFX"

	# choose your own repository, must match git name
	updater.repo = "MC-Assets-Manager"

	#updater.addon = # define at top of module, MUST be done first

	# Website for manual addon download, optional but recommended to set
	updater.website = "https://github.com/BlueEvilGFX/MC-Assets-Manager"
	...
	updater.overwrite_patterns = ["*.png","*.jpg","README.md","LICENSE.txt","*.py"]
