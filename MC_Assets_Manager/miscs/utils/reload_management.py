...
class AddonReloadManagement:
    ...
    def reloadDlcJson(cls) -> None:
        ...
        with open(AddonPathManagement.getDlcMainJson()) as mainJson:                                         #   open dlc main file -> retrieving all dlc data
            ...
            for dlc in dlcList:
                ...
                with open(dlcFile, 'r') as dlcJson:                                     #   open dlc data file -> retrieving original data
                    ...
                    if mainData.get(dlc) is None:                                       #   if does not exist : newly added DLC
                        ...
                        # init_check = AddonPathManagement.getDLCInitPath(dlc)[1]            #   if dlc is script based : deactivate
        ...
        with open(AddonPathManagement.getDlcMainJson(), "w") as jsonFile:
    ...
    def reloadDlcList(cls) -> None:
        ...
        with open(AddonPathManagement.getDlcMainJson(), "r") as json_file:
    ...
    def reloadPresetList(cls) -> None:
        ...
        #   add own presets
        storage = AddonPathManagement.getStorageDirPath()
        icon_dir = os.path.join(storage, "own_presets", "icons")
        ...
        with open(AddonPathManagement.getDlcMainJson(), "r") as json_file:
            ...
            for dlc in dlc_list:
                ...
                if data[dlc]["active"] and has_presets:
                    pr_pa = os.path.join(storage, "DLCs", dlc, "presets")                   #   get directory of preset dlc
    ...
    def reloadAssetList(cls) -> None:
        ...
        #   add own assets
        storage = AddonPathManagement.getStorageDirPath()
        icon_dir = os.path.join(storage, "own_assets", "icons")
        icons = [icon for icon in os.listdir(icon_dir)]
    ...
    def reloadRigList(cls) -> None:
        ...
        #   add own rigs
        storage = AddonPathManagement.getStorageDirPath()
        icon_dir = os.path.join(storage, "own_rigs", "icons")
        icons = [icon for icon in os.listdir(icon_dir)]
